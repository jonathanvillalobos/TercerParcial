...
tk.Label(root, text="Escribe una palabra helmanito").pack()
...
tk.Label(root, text="Espanol").pack()

entrada_esp = tk.Entry(root)
entrada_esp.pack()
entrada_esp.insert(0,"")

tk.Label(root, text="Ingles").pack()
entrada_ing = tk.Entry(root)
entrada_ing.pack()
entrada_ing.insert(0,"")
